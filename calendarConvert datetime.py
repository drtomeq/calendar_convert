...
init_dt = datetime.datetime(1,1,1)
my_dt = datetime.datetime(1,1,1)
...
def repeated_events():
    ...
    for event in events:
        ...
        try: 
        # we do equality to raise if stop repeat not exists
